...
An in-game webview overlay mod for **Minecraft 26.2 (Fabric)** that lets you open a
web page (Minecraft Wiki by default) right inside the game window — so you can look
things up without leaving your world.
...
一个运行于 **Minecraft 26.2 (Fabric)** 的"游戏内浏览器"模组：在游戏窗口正中央召唤
一个固定大小的网页（默认 Minecraft Wiki），方便你在游玩时随时查资料，而不用切出游戏。
